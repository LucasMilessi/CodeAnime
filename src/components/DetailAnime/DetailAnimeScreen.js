    ...
    return (
        <div className="detail_wrapper">
            <div className="detail_main">
                ...
                <div className="text">
                    ...
                    <div className="text_content">
                        <h3>{ (moreInfo && moreInfo.length > 0)   ? moreInfo : `Lo sentimos pero por el momento no tenemos información de este anime`}</h3>
                    </div>
                            ...
                            <div className="avatar-group">
                                {
                                    ...
                                    :(<div className="warning_text">En este momento no tenemos personajes para mostrar</div>)
                                }
                            </div>
                        </div>
                            ...
                            <div className="avatar-group">
                                {
                                    ...
                                    :(<div className="warning_text">En este momento no tenemos personal para mostrar</div>)
                                }
                            </div>
                        </div>
                    </div>
            ...
            <div className="detail_episodes">
                <h3 className="detail_episodes_title">{nameAndDate.name}<span style={{marginLeft:"8px"}}>Episodios</span></h3>
                <div className="cards_episodes">
                    {
                        ...
                        :(<div className="warning_text">En este momento no tenemos episodios para mostrar</div>)
                    }
                </div>
            </div>
            <div className="detail_new">
                <h3>Novedades de este anime</h3>
                <div className="detail_new_deck">
                    {
                        ...
                        :(<div className="warning_text">En este momento no tenemos noticias para mostrar</div>)
                    }
                </div>
            </div>
        </div>
